...
import EditStudentForm from '@/components/Dashboard/Student/EditStudentsForm';
import StudentForm from '@/components/Dashboard/Student/StudentsForm';
import {
  createStudent,
  fetchSingleStudent,
  fetchStudents,
      ...
      {modal && (
        <Modal setModal={setModal} noClose={true}>
          <div className="w-full" onClick={(e) => e.stopPropagation()}>
            ...
            {modalType === 'edit' && (
              <EditStudentForm onCancel={() => setModal(false)} onSubmit={handelEditStudent} />
            )}
          </div>
        </Modal>
      )}
