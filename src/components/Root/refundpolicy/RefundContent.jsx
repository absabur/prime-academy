      ...
      <InnerSection>
        <div className="flex flex-col gap-lg">
          ...
          <p>
            ...
            <Link to="http://www.prime-academy-bd.vercel.app">
              www.prime-academy-bd.vercel.app
            </Link>{' '}
            or you can request a copy at{' '}
            <Link to="mailto:dataprotection@prime-academy-bd.vercel.app">
          ...
          <p>
            ...
            <Link to="http://www.ico.org.uk">www.ico.org.uk</Link>
          </p>
          <PrivacyHeading>
            <strong>
              <u>Policy review</u>
